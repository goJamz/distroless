...
# Debian uses symbolic links that binaries use to find libraries and binaries.
make_symlinks() {
...
# libgcc-s1 is required by Debian's libc6 for unwinding and thread operations.
collect_packages netbase libc6 libgcc-s1
make_symlinks
